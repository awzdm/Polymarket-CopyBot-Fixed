/**
 * Фид цены ETH через Polymarket RTDS (Realtime Data Stream) — тот же
 * принцип, что и btcPriceFeed.ts, только символ eth/usd. Официальный
 * бесплатный WebSocket Polymarket, транслирующий Chainlink-вычисленный
 * TWAP (time-weighted average price). Доступ без API-ключей.
 *
